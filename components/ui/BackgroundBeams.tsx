  ...
  return (
    <div className={`pointer-events-none absolute inset-0 h-full w-full ${className || ''}`}>
      ...
      >
        ...
        <g className="text-foreground/5 dark:text-foreground/10">
          {pathData.map((d, i) => (
            <path key={`static-${i}`} d={d} stroke="currentColor" strokeWidth="0.5" />
          ))}
        </g>
        ...
        <defs>
          {pathData.map((_, i) => (
            ...
            >
              ...
              <stop offset="80%" stopColor="var(--color-accent)" stopOpacity="1" />
